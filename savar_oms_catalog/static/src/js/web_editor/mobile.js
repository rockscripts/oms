odoo.define('savar_oms_catalog.mobile_preview', function (require) {
    'use strict';
    ...
    var MobilePreviewDialog007 = Dialog.include({
        /**
    ...
    var MobileMenu007 = websiteNavbarData.WebsiteNavbarActionWidget.extend({
    ...
    registry.category("website_navbar_widgets").add("MobileMenu", {
        Widget: MobileMenu007,
        selector: 'nav.merchant_navigation_nav li#mobile-menu',
    });
    
    return {
        MobileMenu: MobileMenu007,
        MobilePreviewDialog: MobilePreviewDialog007,
    };
    });